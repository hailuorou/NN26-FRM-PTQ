...
def load_quantized_model(model_path, wbits, abits, group_size,use_act_quant):
    ...
    for i in tqdm(range(len(layers))):
        ...
        if i in (0,39,3,1,28,2,38,24): # llama-2-13b
            group_size = 32
        elif i in (27,31,29,30,34,35): # llama-2-13b
            group_size = 256
        else:
