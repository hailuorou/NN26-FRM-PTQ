...
def load_quantized_model(model_path, wbits, group_size,use_act_quant, sensitive_group, robust_group, abits):
    ...
    for i in tqdm(range(len(layers))):
        ...
        for name, module in named_linears.items():
            q_linear = QuantLinear(wbits, group_size, module.in_features,module.out_features,not module.bias is None, use_act_quant)
